          ...
          <tbody>
            {filteredUsers.map((user, idx) => (
              <tr key={idx} className="border-b border-green-300">
                ...
                <td className="p-2">
                  <span className={`px-2 py-1 rounded-full text-sm text-[#1E40AF] ${user.role === 'CFS' ? 'bg-[#DBEAFE]' : 'bg-[#DCFCE7] text-[#166534]'}`}>
                    {user.role}
                  </span>
                </td>
                <td className="p-2">
...
//       <div className="bg-accent shadow-2xl p-4 rounded-md border-0">
//         <h2 className="text-lg font-semibold mb-3">Container Freight Station(CFS)</h2>
//         <table className="w-full text-left">
//           <thead>
//             <tr className="border-b border-green-300">
//               <th className="p-2">First Name</th>
