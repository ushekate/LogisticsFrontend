    ...
    return (
        <div className="flex flex-col sm:flex-row bg-[var(--background)] min-h-screen text-green-900">
            <main className="flex-1 p-4 sm:p-6 space-y-4">
                <div className="grid items-center gap-4 flex-wrap">
                ...
                <div className="bg-accent shadow-2xl p-4 rounded-md border-0">
                    <h2 className="text-md font-semibold mb-2">CFS Details View Page</h2>
                    <div className="grid sm:grid-cols-2 gap-4 text-sm">
                        <div>
                            <div className="flex mb-1">
                                <User size={25} className="m-2" />
                                <p className="grid"><span className="font-semibold">Name:</span> John Doe</p>
                            </div>
                            <div className="flex mb-1">
                                <Mail size={25} className="m-2" />
                                <p className="grid"><span className="font-semibold">Email:</span> john.doe@example.com</p>
                            </div>
                            <div className="flex mb-1">
                        ...
                        <div>
                            <div className="flex mb-1">
                                ...
                                <p className="grid"><span className="font-semibold">Company:</span> ABC Logistics Ltd.</p>
                            </div>
                            <div className="flex mb-1">
                                <Earth size={25} className="m-2" />
                                <p className="grid"><span className="font-semibold">Location:</span> New York, USA</p>
                            </div>
                            <div className="flex mb-1">
                                <IdCard size={25} className="m-2" />
                                <p className="grid"><span className="font-semibold">ID Proof:</span> DL123456789</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 text-sm">
                        ...
                        <Button
                            ...
                            className="mb-3 bg-green-700 text-white px-4 py-1 rounded text-sm"
                        >
                            <Upload />
                            Upload Images
                        </Button>
